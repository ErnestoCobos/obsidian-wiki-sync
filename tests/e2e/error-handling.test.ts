...
describe('GitHub Wiki Sync E2E Error Handling', () => {
  ...
  test('Handles API errors when getting page content', async () => {
    ...
    expect(Notice).toHaveBeenCalledWith(expect.stringContaining('Pulled 0 updated pages from GitHub Wiki'));
  });
  ...
  test('Handles API errors when updating page content', async () => {
    ...
    // Should show error notice
    expect(Notice).toHaveBeenCalledWith(expect.stringContaining('Pushed 0 updated pages to GitHub Wiki'));
